...
func (r *GatewayPluginAIPromptDecoratorResourceModel) ToSharedCreateAIPromptDecoratorPlugin() *shared.CreateAIPromptDecoratorPlugin {
	...
	var protocols []shared.CreateAIPromptDecoratorPluginProtocols = nil
	...
	if r.Config.Prompts != nil {
		var prepend []shared.Prepend = nil
		...
		var append1 []shared.CreateAIPromptDecoratorPluginAppend = nil
