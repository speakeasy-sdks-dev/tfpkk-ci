...
func (r *GatewayPluginPreFunctionResourceModel) ToSharedCreatePreFunctionPlugin() *shared.CreatePreFunctionPlugin {
	...
	var protocols []shared.CreatePreFunctionPluginProtocols = nil
