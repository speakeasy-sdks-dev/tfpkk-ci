...
func (r *GatewayPluginResponseTransformerResourceModel) ToSharedCreateResponseTransformerPlugin() *shared.CreateResponseTransformerPlugin {
	...
	var protocols []shared.CreateResponseTransformerPluginProtocols = nil
	...
	if r.Config.Replace != nil {
		...
		var jsonTypes []shared.CreateResponseTransformerPluginJSONTypes = nil
	...
	if r.Config.Add != nil {
		...
		var jsonTypes1 []shared.CreateResponseTransformerPluginConfigJSONTypes = nil
	...
	if r.Config.Append != nil {
		...
		var jsonTypes2 []shared.CreateResponseTransformerPluginConfigAppendJSONTypes = nil
